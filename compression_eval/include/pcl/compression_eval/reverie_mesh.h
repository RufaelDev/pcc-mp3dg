//// Basic Mesh Class as used in Reverie Project, we use it as to render output clouds in Reverie
//// Written by Tamy Boubekeur, Paris Tech with modifications from CERTH/ITI and CWI
// --------------------------------------------------------------------------
//
